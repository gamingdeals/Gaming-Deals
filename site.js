...
let games = document.querySelectorAll(".game0").length;
let game_size = document.getElementById("game0").clientWidth + 10;
...
document.getElementById("prevslide0").addEventListener("click", () => {
  if(slide_index>1 && max_slides >= slide_index) {
   ...
   document.getElementById("slider0").style.transition = "transform " + slide_transition + "s linear";
   document.getElementById("slider0").style.transform = "translateX(" + slide_position + "px)";
  }
  else if (max_slides < slide_index) {
   slide_index--;
   slide_position += last_slide_width;
   document.getElementById("slider0").style.transition = "transform " + last_slide_transition + "s linear";
   document.getElementById("slider0").style.transform = "translateX(" + slide_position + "px)";
   
  }
});

document.getElementById("nextslide0").addEventListener("click", () => {
